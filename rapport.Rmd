...
Pour éviter les données de joueurs pros, nous allons commencer par utiliser le dataset ["My First 1000 Valorant Games"](https://www.kaggle.com/datasets/mitchellharrison/my-first-1000-valorant-games) dans lequel on a des stats de kills, morts, assists par match avec l'agent qui a été joué, ce qui peut nous permettre d'étudier des stats variées et précises pour plusieurs agents.

```{r}
dataset5 <- read_csv("data/2. My First 1000 Valorant Games.csv")
dataset5
```
