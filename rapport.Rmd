...
#Pro
perfs_2021 <- read_csv("data/3. Valorant Champion Tour 2021-2026 Data/archive/vct_2021/players_stats/players_stats.csv")
perfs_2022 <- read_csv("data/3. Valorant Champion Tour 2021-2026 Data/archive/vct_2022/players_stats/players_stats.csv")
perfs_2023 <- read_csv("data/3. Valorant Champion Tour 2021-2026 Data/archive/vct_2023/players_stats/players_stats.csv")
perfs_2024 <- read_csv("data/3. Valorant Champion Tour 2021-2026 Data/archive/vct_2024/players_stats/players_stats.csv")
perfs_2025 <- read_csv("data/3. Valorant Champion Tour 2021-2026 Data/archive/vct_2025/players_stats/players_stats.csv")
pros <- bind_rows(
